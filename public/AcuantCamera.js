...
var AcuantCamera = (() => {
  ...
  function start(callback, manualCallback, errorCallback) {
    ...
    acuantCamera.innerHTML=
            '<video id="acuant-player" autoplay playsinline style="display:block; image-orientation:none; object-fit: fill; z-index:1;"></video>' +
            '<canvas id="acuant-ui-canvas" style="display:block; position:absolute; top:0; left:0; z-index;1;"></canvas>';
